import { addObjectToSharedModel, DEFAULT_PLACEMENT_SCHEMA, executeOperator, setVisible } from './tools';
import { handleRemoveObject } from '../panelview';
export var ShapeCreationCommandIDs;
(function (ShapeCreationCommandIDs) {
    ShapeCreationCommandIDs.newBoxWithParams = 'jupytercad:newBoxWithParams';
    ShapeCreationCommandIDs.newCylinderWithParams = 'jupytercad:newCylinderWithParams';
    ShapeCreationCommandIDs.newSphereWithParams = 'jupytercad:newSphereWithParams';
    ShapeCreationCommandIDs.newConeWithParams = 'jupytercad:newConeWithParams';
    ShapeCreationCommandIDs.newTorusWithParams = 'jupytercad:newTorusWithParams';
})(ShapeCreationCommandIDs || (ShapeCreationCommandIDs = {}));
                    ...
                    parameters: {
                        ...
                        properties: {
                            ...
                            Angle: {
                                ...
                                exclusiveMinimum: 0,
                                default: 360,
                                description: 'The angular span of the cylinder in degrees (0 = none, 360 = full).'
                            },
                            Color: {
                                type: 'string',
                ...
                properties: {
                    ...
                    parameters: {
                        ...
                        properties: {
                            ...
                            Angle1: {
                                type: 'number',
                                description: 'The lower polar angle limit in degrees (start of the vertical sweep, -90 = bottom pole).',
                                default: -90
                            },
                            Angle2: {
                                type: 'number',
                                description: 'The upper polar angle limit in degrees (end of the vertical sweep, 90 = top pole).',
                                default: 90
                            },
                            Angle3: {
                                type: 'number',
                                description: 'The azimuthal angle in degrees defining the sweep around the Z axis (360 = full sphere, < 360 = spherical wedge).',
                                default: 360
                            },
                            Color: {
                                type: 'string',
                    ...
                    parameters: {
                        ...
                        properties: {
                            Radius1: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                description: 'The radius of the bottom face of the cone (base circle).'
                            },
                            Radius2: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                description: 'The radius of the top face of the cone (tip circle). Set to 0 for a true cone.'
                            },
                            Height: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                description: 'The height of the cone along its local Z axis (distance between top and bottom faces).'
                            },
                            Angle: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                default: 360,
                                description: 'The angular span of the cone in degrees (360 = full cone, < 360 = sector).'
                            },
                            Color: {
                                type: 'string',
                    ...
                    parameters: {
                        ...
                        properties: {
                            Radius1: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                description: 'The major radius of the torus (distance from the center of the torus to the center of the tube)'
                            },
                            Radius2: {
                                type: 'number',
                                exclusiveMinimum: 0,
                                description: 'The minor radius of the torus (radius of the tube cross-section).'
                            },
                            Angle1: {
                                type: 'number',
                                default: -180,
                                description: 'The start angle of the torus ring segment in degrees (defines the beginning of the sweep around the main axis).'
                            },
                            Angle2: {
                                type: 'number',
                                default: 180,
                                description: 'The end angle of the torus ring segment in degrees (defines the end of the sweep around the main axis).'
                            },
                            Angle3: {
                                type: 'number',
                                default: 360,
                                description: 'The angular span of the tube cross-section in degrees (360 = full tube, < 360 = partial tube).'
                            },
                            Color: {
                                type: 'string',
...
export var DocumentActionCommandIDs;
(function (DocumentActionCommandIDs) {
    DocumentActionCommandIDs.undoWithParams = 'jupytercad:undoWithParams';
    DocumentActionCommandIDs.redoWithParams = 'jupytercad:redoWithParams';
    DocumentActionCommandIDs.removeObjectWithParams = 'jupytercad:removeObjectWithParams';
    DocumentActionCommandIDs.editShapeWithParams = 'jupytercad:editShapeWithParams';
})(DocumentActionCommandIDs || (DocumentActionCommandIDs = {}));
export function addDocumentActionCommands(options) {
    ...
    commands.addCommand(DocumentActionCommandIDs.removeObjectWithParams, {
        ...
        execute: ((args) => {
            ...
            handleRemoveObject(objectId, sharedModel, () => sharedModel.awareness.setLocalStateField('selected', {}));
        })
    });
    commands.addCommand(DocumentActionCommandIDs.editShapeWithParams, {
        ...
        describedBy: {
            args: {
                ...
                properties: {
                    ...
                    objectProperties: {
                        type: 'object',
                        description: 'The properties of the object to be edited, it must match the parameter schema of the object being edited'
                    }
                }
            }
        },
        execute: (async (args) => {
            ...
            await current.content.currentViewModel.maybeUpdateObjectParameters(objectName, objectProperties);
        })
    });
}
export var ShapeOperationCommandIDs;
(function (ShapeOperationCommandIDs) {
    ShapeOperationCommandIDs.cutWithParams = 'jupytercad:cutWithParamsWithParams';
    ShapeOperationCommandIDs.extrusionWithParams = 'jupytercad:extrusionWithParams';
    ShapeOperationCommandIDs.unionWithParams = 'jupytercad:unionWithParams';
    ShapeOperationCommandIDs.intersectionWithParams = 'jupytercad:intersectionWithParams';
    ShapeOperationCommandIDs.chamferWithParams = 'jupytercad:chamferWithParams';
    ShapeOperationCommandIDs.filletWithParams = 'jupytercad:filletWithParams';
})(ShapeOperationCommandIDs || (ShapeOperationCommandIDs = {}));
export function addShapeOperationCommands(options) {
    ...
    commands.addCommand(ShapeOperationCommandIDs.cutWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Cut', objectModel, current, (sharedModel) => {
    ...
    commands.addCommand(ShapeOperationCommandIDs.extrusionWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Extrusion', objectModel, current, (sharedModel) => {
                setVisible(sharedModel, parameters['Base'], false);
                sharedModel.addObject(objectModel);
            });
        })
    ...
    commands.addCommand(ShapeOperationCommandIDs.intersectionWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Intersection', objectModel, current, (sharedModel) => {
    ...
    commands.addCommand(ShapeOperationCommandIDs.unionWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Fuse', objectModel, current, (sharedModel) => {
                parameters.Shapes.map((shape) => {
                    setVisible(sharedModel, shape, false);
                });
                sharedModel.addObject(objectModel);
    ...
    commands.addCommand(ShapeOperationCommandIDs.chamferWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Chamfer', objectModel, current, (sharedModel) => {
                setVisible(sharedModel, parameters.Base, false);
                sharedModel.addObject(objectModel);
            });
        })
    ...
    commands.addCommand(ShapeOperationCommandIDs.filletWithParams, {
        ...
        execute: (async (args) => {
            ...
            return executeOperator('Fillet', objectModel, current, (sharedModel) => {
                setVisible(sharedModel, parameters.Base, false);
                sharedModel.addObject(objectModel);
            });
        })
